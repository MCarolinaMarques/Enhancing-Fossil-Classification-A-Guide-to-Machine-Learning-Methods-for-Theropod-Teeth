    ...
    for scaler_name, scaler in scalers:
        for sampler_name, sampler in oversamplers:
            ...
            for train_idx, test_idx in kf.split(X,y):
                ...
                table_save_path = f"5Tables_clade/table_{method_name}_{scaler_name}_{sampler_name}.csv"
            ...
            model_save_path = f"5ModelResultsnew_clade/model_{method_name}_{scaler_name}_{sampler_name}.joblib"
            scaler_save_path = f"5ModelResultsnew_clade/scaler_{method_name}_{scaler_name}_{sampler_name}.joblib"
            ...
            filename = f"5Plotsnew_clade/{method_name}_{scaler_name}_{sampler_name}_importances.png"
            ...
            results['MeanRecall'].append(mean_recall)  # Store mean recall
            results['SdRecall'].append(sd_recall)  # Store SD of recall
...
csv_file_path = '5teeth_data_clade_resultsnew.csv'
tcsv_file_path = '5teeth_data_clade_results_trainnew.csv'
    ...
    for i, (scaler_name, scaler) in enumerate(scalers):
       ...
       #     plt.title(f'{method_name}+ {scaler_name} + {sampler_name} (Mean)')
           ...
           # plt.title(f'{method_name}+{scaler_name} + {sampler_name} (Std Dev)')
            ...
            # Adjust layout and show the plot
            plt.tight_layout()
            filename = f"5Plotsnew_clade/sd_{method_name}_{scaler_name}_{sampler_name}_cm.png"
            plt.savefig(filename)
            plt.show()
            ...
            sns.set(font_scale=3.5)  # Increase font scale
            sns.heatmap(pmean_cm, annot=True, fmt='.0f', cmap='Blues', annot_kws={"size":21},
                        cbar=False, square=True, 
                        xticklabels=unique_classes,  # Adjust according to your classes
                        yticklabels=unique_classes)  # Adjust according to your classes
       #     plt.title(f'{method_name}+ {scaler_name} + {sampler_name} (Mean)')
            ...
            # Adjust layout and show the plot
            plt.tight_layout()
            filename = f"5Plotsnew_clade/prop_mean_{method_name}_{scaler_name}_{sampler_name}_cm.png"
            plt.savefig(filename)
            plt.show()
           ...
           # plt.title(f'{method_name}+{scaler_name} + {sampler_name} (Std Dev)')
            ...
            # Adjust layout and show the plot
            plt.tight_layout()
            filename = f"5Plotsnew_clade/prop_sd_{method_name}_{scaler_name}_{sampler_name}_cm.png"
            plt.savefig(filename)
            plt.show()
...
# Define the path where you want to save the CSV file
csv_file_path = '5teeth_data_clade_results_nnnew.csv'
tcsv_file_path = '5teeth_data_clade_results_train_nnnew.csv'
...
for k, (method_name, method) in enumerate(methods):
    for i, (scaler_name, scaler) in enumerate(scalers):
       ...
       #     plt.title(f'{method_name}+ {scaler_name} + {sampler_name} (Mean)')
            ...
            # Adjust layout and show the plot
            plt.tight_layout()
            filename = f"C:/Users/carol/Dropbox/PhD_Paleo_stuff/Dentes/5Plotsnew_clade/mean_{method_name}_{scaler_name}_{sampler_name}_cm.png"
            plt.savefig(filename)
            plt.show()
           ...
           # plt.title(f'{method_name}+{scaler_name} + {sampler_name} (Std Dev)')
            ...
            # Adjust layout and show the plot
            plt.tight_layout()
            filename = f"C:/Users/carol/Dropbox/PhD_Paleo_stuff/Dentes/5Plotsnew_clade/sd_{method_name}_{scaler_name}_{sampler_name}_cm.png"
            plt.savefig(filename)
            plt.show()
  ...
  # Get mean and std confusion matrices for the current combination
       ...
       #     plt.title(f'{method_name}+ {scaler_name} + {sampler_name} (Mean)')
            ...
            # Adjust layout and show the plot
            plt.tight_layout()
            filename = f"C:/Users/carol/Dropbox/PhD_Paleo_stuff/Dentes/5Plotsnew_clade/prop_mean_{method_name}_{scaler_name}_{sampler_name}_cm.png"
            plt.savefig(filename)
            plt.show()
           ...
           # plt.title(f'{method_name}+{scaler_name} + {sampler_name} (Std Dev)')
            ...
            # Adjust layout and show the plot
            plt.tight_layout()
            filename = f"C:/Users/carol/Dropbox/PhD_Paleo_stuff/Dentes/5Plotsnew_clade/prop_sd_{method_name}_{scaler_name}_{sampler_name}_cm.png"
            plt.savefig(filename)
            plt.show()
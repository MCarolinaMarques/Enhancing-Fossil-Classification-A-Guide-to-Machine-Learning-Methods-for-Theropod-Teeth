...
# Load the data
data = pd.read_csv('teeth_data_taxa_epoch1.csv')
    ...
    for scaler_name, scaler in scalers:
        for sampler_name, sampler in oversamplers:
            ...
            for train_idx, test_idx in kf.split(X,y):
                ...
                table_save_path = f"5Tables/table_{method_name}_{scaler_name}_{sampler_name}.csv"
            ...
            model_save_path = f"5ModelResultsnew/model_{method_name}_{scaler_name}_{sampler_name}.joblib"
            scaler_save_path = f"5ModelResultsnew/scaler_{method_name}_{scaler_name}_{sampler_name}.joblib"
            ...
            filename = f"5Plotsnew/{method_name}_{scaler_name}_{sampler_name}_importances.png"
...
csv_file_path = '5teeth_data_genus_resultsnew.csv'
tcsv_file_path = '5teeth_data_genus_results_trainnew.csv'
...
for k, (method_name, method) in enumerate(methods):
    for i, (scaler_name, scaler) in enumerate(scalers):
       ...
       #     plt.title(f'{method_name}+ {scaler_name} + {sampler_name} (Mean)')
            ...
            plt.tight_layout()
            filename = f"5Plotsnew/mean_{method_name}_{scaler_name}_{sampler_name}_cm.png"
            plt.savefig(filename)
            plt.show()
           ...
           # plt.title(f'{method_name}+{scaler_name} + {sampler_name} (Std Dev)')
            ...
            # Adjust layout and show the plot
            plt.tight_layout()
            filename = f"5Plotsnew/sd_{method_name}_{scaler_name}_{sampler_name}_cm.png"
            plt.savefig(filename)
            plt.show()
       ...
       #     plt.title(f'{method_name}+ {scaler_name} + {sampler_name} (Mean)')
            ...
            # Adjust layout and show the plot
            plt.tight_layout()
            filename = f"5Plotsnew/prop_mean_{method_name}_{scaler_name}_{sampler_name}_cm.png"
            plt.savefig(filename)
            plt.show()
           ...
           # plt.title(f'{method_name}+{scaler_name} + {sampler_name} (Std Dev)')
            ...
            # Adjust layout and show the plot
            plt.tight_layout()
            filename = f"5Plotsnew/prop_sd_{method_name}_{scaler_name}_{sampler_name}_cm.png"
            plt.savefig(filename)
            plt.show()
...
# Define the path where you want to save the CSV file
csv_file_path = '5teeth_data_genus_results_nnnew.csv'
tcsv_file_path = '5teeth_data_genus_results_train_nnnew.csv'

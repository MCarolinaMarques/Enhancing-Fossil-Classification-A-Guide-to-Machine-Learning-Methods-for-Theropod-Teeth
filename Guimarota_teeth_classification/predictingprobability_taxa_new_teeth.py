...
sc=joblib.load('C:/Users/carol/Dropbox/PhD_Paleo_stuff/Dentes/5ModelResultsnew_ne/scaler_Random Forest_StandardScaler_KMeansSMOTE.joblib')
...
#rf_model is the trained Random Forest model and X is the test data
...
# Save to a CSV file
results.to_excel(
    'C:/Users/carol/Dropbox/PhD_Paleo_stuff/Dentes/results_new_teeth_guimarota_taxa.xlsx', 
    index=False
)
